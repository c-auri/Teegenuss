...
function Address() {
    return <section className="py-10 border-t-2 border-gray-900">
        {Heading("Anschrift")}
...
function Contact() {
    return <section className="w-full py-10 border-t-2 border-gray-900 md:pl-24 xl:px-24">
        {Heading("Kontakt")}
        <form className="max-w-xl grid gap-4">
            <div className="text-lg">
                <p>Fragen oder Anregungen?</p>
                <p>Schreib mir eine Nachricht und ich komme auf dich zurück.</p>
            </div>
            <fieldset className="grid gap-5">
                ...
                <p className="flex flex-col gap-1 md:col-span-2">
                    ...
                    <textarea className="my-1 border border-gray-800 focus:outline-none focus:border-gray-600 p-2 rounded-md bg-gray-900 text-gray-300" id="message" name="message" rows="6" title="Bitte gib deine Nachricht ein."></textarea>
                </p>
                <button className="py-2 px-16 border border-gray-900 md:justify-self-start hover:border-gray-500 focus:outline-none focus:border-gray-500 rounded-md hover:text-gray-300">Absenden</button>
            </fieldset>
        </form>
    </section>
}
...
function Heading(text) {
    return <h2 className="mb-4 font-bold text-gray-300 text-xl lg:text-2xl">{text}</h2>
}