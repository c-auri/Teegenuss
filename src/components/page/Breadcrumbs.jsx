export default function Breadcrumbs({ navigation }) {
    ...
    return navigation.segments.map((segment, segmentIndex) => (
        <div key={`segment-${segmentIndex}`} className="group flex items-center select-none tracking-wider text-md text-gray-400 fill-gray-400 hover:fill-gray-500 hover:text-gray-500">
