export default function Breadcrumbs({ navigation }) {
    ...
    return navigation.segments.map((segment, segmentIndex) => (
        <div key={`segment-${segmentIndex}`} className="flex items-center select-none tracking-wider text-md text-gray-400 fill-gray-400 hover:fill-gray-500 hover:text-gray-500">
            <div className="relative group cursor-pointer pl-2 pr-5 py-1 rounded-md hover:bg-gray-200">
                ...
                <span className="">{segment.entry.data.title}</span>
